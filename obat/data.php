    ...
    <div class="box">
		...
		<form action="" class="form-inline" method="post">
			<div class="form-group">
				<input type="text" name="pencarian" id="" class="form-control" placeholder="Pencarian">
			</div>
			<div class="form-group">
									...
									while ( $data = mysqli_fetch_array($sql_obat) ) : ?>
										<tr>
											...
											<td class="text-center">
												...
												<a href="del.php?id=<?= $data['id_obat'] ?>" onclick="return confirm( 'Yakin ingin menghapus <?=  $data['nama_obat'];  ?> ?' )" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
											</td>
